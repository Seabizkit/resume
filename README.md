...
🇿🇦 South African Citizen | 🇬🇧 British Citizen

---

# Professional Summary

Senior Technical Lead and Software Architect with 15+ years of experience designing, evolving and delivering complex software systems across fintech and high-volume transaction platforms. My experience spans both legacy and modern .NET ecosystems, giving me a pragmatic understanding of how systems evolve in the real world.

I specialise in software architecture, distributed systems, API design, system integration and technical leadership. Rather than applying patterns or technologies for their own sake, I focus on the constraints of the existing system, the business requirements and the desired future state, then design an architecture that can realistically get there.
...
- 🚀 200+ production deployments orchestrated at a single fintech platform
...
- Drove rigorous code review and enforced testing discipline on all changes, removing the need for a dedicated QA function and delivering 200+ production deployments with virtually zero rollbacks and no downtime.
- Preserved backward compatibility of API contracts across the service dependency chain, enabling independent, zero-downtime deployments rather than coordinated lockstep releases.
...
- Optimise systems using evidence rather than assumptions.
- Design systems that are easy to evolve.
- Mentor engineers and improve team capability.
- Automate repetitive work wherever practical.
